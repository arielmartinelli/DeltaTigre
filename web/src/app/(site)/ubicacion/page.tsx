...
const steps = [
  ...
  { icon: "boat", t: "Tomá la lancha colectiva", d: "En la Estación Fluvial de Tigre salen las lanchas de línea: cada 30 minutos los fines de semana y cada 1 hora los días de semana. El viaje es de unos 15 minutos. Te pasamos toda la información al confirmar la reserva." },
